...
public class PureJuickCompatibleURLMessagesSource extends PureMessageSource {
    ...
    @Override
    public void getChildren(JuickMessage parent, Utils.Notification notification, Utils.Function<Void, ArrayList<JuickMessage>> cont) {
        ArrayList<JuickMessage> download = new PureJuickChildrenDownloader().download(parent.getMID(), httpClientService, notification, false);
        cont.apply(download);
    }
